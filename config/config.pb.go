// To update the Funnel config:
// - Edit `config/config.proto`
// - Run `make proto-depends` and then `make proto`
...
type Kubernetes struct {
	...
	// Configure this when using S3Files as PV backend
	S3FilesFilesystemId string `protobuf:"bytes,20,opt,name=S3FilesFilesystemId,proto3" json:"S3FilesFilesystemId,omitempty"`
	unknownFields       protoimpl.UnknownFields
	sizeCache           protoimpl.SizeCache
}
...
func (x *Kubernetes) GetS3FilesFilesystemId() string {
	if x != nil {
		return x.S3FilesFilesystemId
	}
	return ""
}
...
const file_config_config_proto_rawDesc = "" +
	...
	"\fTemplateFile\x18\x02 \x01(\tR\fTemplateFile\"\xd3\v\n" +
	"\x06Config\x12\"\n" +
	...
	"\bPostgres\x18! \x01(\v2\x10.config.PostgresR\bPostgres\x12.\n" +
	...
	"Kubernetes\x12,\n" +
	"\bGCPBatch\x18\x18 \x01(\v2\x10.config.GCPBatchR\bGCPBatch\x128\n" +
	"\fLocalStorage\x18\x19 \x01(\v2\x14.config.LocalStorageR\fLocalStorage\x123\n" +
	"\bAmazonS3\x18\x1a \x01(\v2\x17.config.AmazonS3StorageR\bAmazonS3\x126\n" +
	"\tGenericS3\x18\x1b \x03(\v2\x18.config.GenericS3StorageR\tGenericS3\x12@\n" +
	"\rGoogleStorage\x18\x1c \x01(\v2\x1a.config.GoogleCloudStorageR\rGoogleStorage\x12*\n" +
	"\x05Swift\x18\x1d \x01(\v2\x14.config.SwiftStorageR\x05Swift\x125\n" +
	"\vHTTPStorage\x18\x1e \x01(\v2\x13.config.HTTPStorageR\vHTTPStorage\x122\n" +
	"\n" +
	"FTPStorage\x18\x1f \x01(\v2\x12.config.FTPStorageR\n" +
	"FTPStorage\x12)\n" +
	"\aPlugins\x18  \x01(\v2\x0f.config.PluginsR\aPlugins\"\x8d\x01\n" +
	"\aPlugins\x12\x12\n" +
	...
	"\tAWSConfig\x18\x05 \x01(\v2\x11.config.AWSConfigR\tAWSConfig\"\x83\x02\n" +
	"\bGCPBatch\x12\x1a\n" +
	...
	"\bGCPBatch\x18\x06 \x01(\v2\x10.config.GCPBatchR\bGCPBatch\"O\n" +
	"\tDatastore\x12\x18\n" +
	...
	"\tAWSConfig\x18\x03 \x01(\v2\x11.config.AWSConfigR\tAWSConfig\"\xde\x01\n" +
	...
	"\bKmsKeyID\x18\a \x01(\tR\bKmsKeyID\x12\x1c\n" +
	"\tAccountID\x18\b \x01(\tR\tAccountID\"\xa0\x02\n" +
	...
	"\x04User\x18\x03 \x01(\tR\x04User\x12\x1a\n" +
	"\bPassword\x18\x04 \x01(\tR\bPassword\"\xe2\a\n" +
	"\n" +
	"Kubernetes\x12\x1a\n" +
	...
	"\aTimeout\x18\x13 \x01(\v2\x15.config.TimeoutConfigR\aTimeout\x120\n" +
	"\x13S3FilesFilesystemId\x18\x14 \x01(\tR\x13S3FilesFilesystemId\x1a?\n" +
...
var file_config_config_proto_goTypes = []any{
	...
	(*Postgres)(nil),            // 17: config.Postgres
	...
	(*GCPBatch)(nil),            // 23: config.GCPBatch
	(*Datastore)(nil),           // 24: config.Datastore
	(*DynamoDB)(nil),            // 25: config.DynamoDB
	(*LocalStorage)(nil),        // 26: config.LocalStorage
	(*GoogleCloudStorage)(nil),  // 27: config.GoogleCloudStorage
	(*SSE)(nil),                 // 28: config.SSE
	(*AmazonS3Storage)(nil),     // 29: config.AmazonS3Storage
	(*GenericS3Storage)(nil),    // 30: config.GenericS3Storage
	(*SwiftStorage)(nil),        // 31: config.SwiftStorage
...
var file_config_config_proto_depIdxs = []int32{
	...
	24, // 13: config.Config.Datastore:type_name -> config.Datastore
	17, // 14: config.Config.Postgres:type_name -> config.Postgres
	13, // 15: config.Config.HTCondor:type_name -> config.HPCBackend
	13, // 16: config.Config.Slurm:type_name -> config.HPCBackend
	13, // 17: config.Config.PBS:type_name -> config.HPCBackend
	0,  // 18: config.Config.GridEngine:type_name -> config.GridEngine
	22, // 19: config.Config.AWSBatch:type_name -> config.AWSBatch
	34, // 20: config.Config.Kubernetes:type_name -> config.Kubernetes
	23, // 21: config.Config.GCPBatch:type_name -> config.GCPBatch
	26, // 22: config.Config.LocalStorage:type_name -> config.LocalStorage
	29, // 23: config.Config.AmazonS3:type_name -> config.AmazonS3Storage
	30, // 24: config.Config.GenericS3:type_name -> config.GenericS3Storage
	27, // 25: config.Config.GoogleStorage:type_name -> config.GoogleCloudStorage
	31, // 26: config.Config.Swift:type_name -> config.SwiftStorage
